...
public:
    ...
    Token* CreateKeywordToken(size_t line_number, size_t column_number, TOKEN_TYPE token_type);
    ...
    Token* CreateCommentToken(size_t line_number, size_t column_number, const char* text, TOKEN_TYPE token_type);
