...
using mizcore::QueryElementTypeText;
using mizcore::QueryBlockTypeText;
using mizcore::QueryIdentifierTypeText;
using mizcore::QuerySpecialSymbolText;
using mizcore::QueryCommentTypeText;
using mizcore::QueryKeywordText;
...
PYBIND11_MODULE(py_miz_controller, m)
{
    m.def("query_token_type_text", &QueryTokenTypeText)
      .def("query_identifier_type_text", &QueryIdentifierTypeText)
      .def("query_comment_type_text", &QueryCommentTypeText)
      .def("query_keyword_text", &QueryKeywordText)
      .def("query_special_symbol_text", &QuerySpecialSymbolText)
      .def("query_element_type_text", &QueryElementTypeText)
      .def("query_block_type_text", &QueryBlockTypeText);
